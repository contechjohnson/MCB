...
CREATE INDEX IF NOT EXISTS idx_stripe_logs_created_at ON stripe_webhook_logs(created_at DESC);
CREATE INDEX IF NOT EXISTS idx_stripe_logs_status ON stripe_webhook_logs(status);
CREATE INDEX IF NOT EXISTS idx_stripe_logs_matched_contact ON stripe_webhook_logs(matched_contact_id);
